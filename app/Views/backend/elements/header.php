		...
		<div class="header">
			<div class="main-header">
				...
				<div class="header-left active">
					<a href="<?php echo base_url('public/backend/images/city/log.png') ?>" class="logo logo-normal">
						<img src="<?php echo base_url('public/backend/images/city/log.png') ?>" alt="Img">
					</a>
					<a href="<?php echo base_url('public/backend/images/city/log.png') ?>" class="logo logo-white">
						<img src="<?php echo base_url('public/backend/images/city/log.png') ?>" alt="Img">
					</a>
					<a href="<?php echo base_url('public/backend/images/city/log.png') ?>" class="logo-small">
						<img src="<?php echo base_url('public/backend/images/city/log.png') ?>" alt="Img">
					</a>
				</div>
				<!-- /Logo -->
