		...
		<div class="sidebar" id="sidebar">
			...
			<div class="sidebar-logo active">
				<a href="index.html" class="logo logo-normal">
					<img src="<?= base_url('public/fe/img/royalking.png') ?>" alt="Img" height="50" width="50" >
				</a>
				...
				<div id="sidebar-menu" class="sidebar-menu">
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								<li><a href="<?= base_url('/room') ?>"><i data-feather="box"></i><span>Room</span></a></li>
								<li><a href="<?= base_url('/booking') ?>"><i class="ti ti-table-plus fs-16 me-2"></i><span>Booking</span></a></li>
								<li><a href="<?= base_url('/facility') ?>"><i class="ti ti-progress-alert fs-16 me-2"></i><span>Facility</span></a></li>
								<li><a href="<?= base_url('/facilityfeatures') ?>"><i class="ti ti-trending-up-2 fs-16 me-2"></i><span>Facility Feature</span></a></li>

								<li><a href="<?= base_url('/superadmin') ?>"><i class="ti ti-checklist fs-16 me-2"></i><span>logout</span></a></li>
									</ul>
						</li>
						<li class="submenu-open">
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="admin-dashboard.html">BLURB</a></li>
